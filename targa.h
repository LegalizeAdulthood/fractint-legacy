...
/**************************************************************************/
/* tinit.c */
extern int  GraphInit( int board );
extern void GraphEnd( void );

/* tsubs.c */
extern void VCenterDisplay( int nLines );
extern void SetDispReg( int reg, int value );
extern int  VWait( void );
extern void SetVBorder( int top, int bottom );
extern void SetRGBorCV( int type );
extern void SetVCRorCamera( int type );
extern void SetBorderColor( long * color );
extern void SetMask( int mask );
extern void SetVertShift( int preshift );
extern void SetOverscan( int mode );						 	
extern void SetInterlace( int type );
extern void SetBlndReg( int value );
extern void TSetMode( int mode );
extern void SetContrast( int level );
extern void SetHue( int level );
extern void SetSaturation( int level );
extern int  GetPageMode( void );
extern void SetHBorder(int left, int right );
extern int  GetLine( int port  );

/* erase.c */
extern void Erase( int color );
